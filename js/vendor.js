...
<div class="modal-body" style="overflow-y:auto;max-height:80vh">
  <form onsubmit="submitAddProduct(event,'${storeId}','${vendorId}')">
    ...
    <div class="form-group">
      ...
      <div style="display:flex;gap:8px">
        <input class="form-control" id="new-p-name" placeholder="e.g. Nike Air Max 90" required oninput="_localAutoFill('new-p')" style="flex:1">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="new-p-desc" rows="3" placeholder="Describe your product..."></textarea>
    </div>
