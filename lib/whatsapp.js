...
/**
 * Non-secret configuration status, safe to return to the frontend.
 * Never exposes the token or phone number ID values themselves.
 */
function getConfigStatus() {
  ...
  return {
    ...
    adminBaseUrlConfigured: !!adminBaseUrl()
  };
}
