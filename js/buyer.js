    ...
    <div style="display:flex;align-items:center;gap:14px;background:#fff;padding:16px;border-radius:var(--radius-md);border:1px solid var(--border);margin-bottom:16px;box-shadow:var(--shadow-sm)">
      ...
      <div style="flex:1">
        ...
        <div style="display:flex;align-items:center;gap:6px;margin-top:4px;flex-wrap:wrap">
          ...
          <button class="btn btn-outline" onclick="showPage('support')" style="padding:2px 8px;font-size:.72rem;display:inline-flex;align-items:center;gap:4px;height:auto;line-height:1">
